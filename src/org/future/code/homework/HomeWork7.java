...
public class HomeWork7 {
    ...
    public static List<String> methodOne(List<String> names) {
        // Твой код здесь
        return names.stream().filter(o -> o.contains("King")).collect(Collectors.toList());
    }
    ...
    public static List<String> methodTwo(List<String> names) {
        // Твой код здесь
        return names.stream().map(n -> n.substring(n.indexOf(" ") + 1)).distinct().collect(Collectors.toList());
    }
    ...
    public static List<String> methodThree(List<String> names) {
        // Твой код здесь
        return names.stream().map(n -> n.substring(0, n.indexOf(" "))).distinct().filter(o -> o.startsWith("L")).collect(Collectors.toList());
    }
    ...
    public static List<String> methodFour(List<String> names) {
        // Твой код здесь
        return names.stream().map(n -> n.substring(n.indexOf(" ") + 1)).distinct().filter(n -> n.startsWith("W")).sorted().collect(Collectors.toList());
    }
    ...
    public static Integer methodFive(List<String> names) {
        // Твой код здесь
        return (int)names.stream().map(n -> n.substring(0, n.indexOf(" "))).filter(n -> n.length() > 6).distinct().count();
    }
    ...
    public static Integer methodSix(List<String> names) {
        // Твой код здесь
        return (int)names.stream().flatMap(n -> Stream.of(n.split(" "))).filter(n -> n.length() > 5).distinct().count();
    }
    ...
    public static List<String> methodSeven(List<String> names) {
        // Твой код здесь
        return names.stream().filter(n-> n.substring(n.indexOf(" ") + 1).startsWith("K")|| n.substring(n.indexOf(" ") + 1).startsWith("S")).map(n -> n.substring(0, n.indexOf(" ") + 2)).map(o -> o+= ".").distinct().sorted().collect(Collectors.toList());
    }
